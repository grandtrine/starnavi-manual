...
![The tri-wheel input fields (the direction type selector and the transit date)](assets/triple-chart-01-input.jpg)
...
![The right panel (the Overview tab, listing N, the progressed chart, and T)](assets/triple-chart-05-panel.jpg)
...
![The ephemeris button and dialog on the tri-wheel screen](assets/triple-chart-03-ephemeris.jpg)
