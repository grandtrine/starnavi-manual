...
!!! abstract "この章について"
    ...
    **エッセンシャルディグニティ**（ディグニティ表・スコア）と **アルムーテン** は、この章の機能ではなく一重円の「分析」タブに表示されます（**Pro 以上**）。見方は [分析タブ](analysis-tab.md) の章をご覧ください。
...
![7つのロットを表示した一重円。円盤上に略号入りの丸印が配置され、右パネルの「天体」タブにフォーチュン・スピリット・エロス・ネセシティ・カレッジ・ネメシス・ヴィクトリーの行が並んでいる](assets/traditional-03-lots.png)
...
3. 右パネルの「**天体**」タブにも、選んだロットのサイン・度数・ハウスが表示されます。
...
6. 作成したロットは「ロット（アラビックパーツ）」のチェック欄に標準のロットと並びます。チェックを入れると、チャートと「天体」タブに表示されます。
...
1. 「古典（Traditional）」の「**アンティシア・リング表示**」で、必要な項目にチェックを入れます。
    ...
    - **天体一覧にアンティシア列**：右パネルの「天体」タブに、アンティシアの位置の列が加わります。
