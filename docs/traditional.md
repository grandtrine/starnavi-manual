...
<!-- 画像未撮影: 設定画面の「古典（Traditional）」セクションを開いた状態 → assets/traditional-01-settings.jpg -->
...
<!-- 画像未撮影: プロフェクションの年表（今年の行が色付き・月次が展開された状態） → assets/traditional-02-profection.jpg -->
...
<!-- 画像未撮影: ロットを表示した一重円チャート（円盤上の丸印と右パネルのロット行） → assets/traditional-03-lots.jpg -->
...
<!-- 画像未撮影: カスタムロットの作成ダイアログ（名前・基点・加える点・引く点・式のプレビュー） → assets/traditional-04-custom-lot.jpg -->
...
<!-- 画像未撮影: アンティシアをホイールに表示した状態＋アスペクトタブのコンタクト一覧 → assets/traditional-05-antiscia.jpg -->
...
<!-- 画像未撮影: タームリング・フェイスリングを表示した一重円チャート → assets/traditional-06-rings.jpg -->
...
<!-- 画像未撮影: プロフェクションリングを表示した一重円チャート＋期間の選択欄 → assets/traditional-07-profection-ring.jpg -->
