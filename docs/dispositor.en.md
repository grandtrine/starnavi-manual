...
- **Modern** traces Scorpio, Aquarius, and Pisces to Pluto, Uranus, and Neptune; **Traditional** traces them to Mars, Saturn, and Jupiter. The other signs are the same in both. Modern is the initial setting; your choice is stored in your browser and used next time.
- The planets covered are the ten from Sun to Pluto: Sun, Moon, Mercury, Venus, Mars, Jupiter, Saturn, Uranus, Neptune, and Pluto. The lunar nodes, ASC/MC, and asteroids are not connected by arrows.
- The planets drawn follow the **Planet display** setting (natal) on the settings screen. Planets you have hidden are not shown, and their arrows are not drawn either.
- The wheel colors and glyphs follow your selected color theme and glyph settings.
