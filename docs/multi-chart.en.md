...
1. **Slot planets** lets you choose which planets are shown for each slot. It applies both to the chart on display and to the planet list below it.
2. After calculating, the **Print** button prints the charts and the data.
