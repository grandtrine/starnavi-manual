...
![The return chart input fields (return type selector, phase angle, search year, custom location)](assets/return-chart-01-input.jpg)
...
!!! warning "The planets on the outer ring (the return chart) follow the transit settings"
...
![The list of return dates (a lunar return, with the date on display highlighted in yellow)](assets/return-chart-03-dates.jpg)
...
![The right panel (the Return tab, listing the planets of the return chart)](assets/return-chart-04-panel.jpg)
