...
- データタブに表示されるのは、選択している「**プリセット**」で選んでいる項目だけです。各タブに表示される内容は次のとおりです。
    ...
    - **分析タブ**: 月相 / 三区分 / 四区分 / 二分法（陽・陰） / 半球の強調 / ゴークランセクターの天体 / ステリウム / 特殊度数の集計と、支配星をたどる矢印をチャートに重ねた「**ディスポジター**」の図（Pro 以上）、そして「**チャート詳細**」（タイトなアスペクト・最多アスペクト天体・アンギュラー天体・ASC支配星・エッセンシャルディグニティ（アルムーテンを含む。Pro 以上）・ドデカテモリー・アンティシオン・ミューチュアルリセプション）を表示します。各項目の見方は [分析タブ](analysis-tab.md) の章、ディスポジターの図は [ディスポジター](dispositor.md) の章をご覧ください。
